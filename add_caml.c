...
#define camlidl_cudd_ml2c_add_add__t(v,c,ctx) camlidl_cudd_node_ml2c(v,c)

#define camlidl_cudd_c2ml_add_add__t(c,ctx) camlidl_cudd_node_c2ml(c)

value camlidl_cudd_add_dthen(
	value _v_no)
{
  add__t no; /*in*/
  add__t _res;
  ...
  camlidl_cudd_ml2c_add_add__t(_v_no, &no, _ctx);
...
_res.node = cuddT(no.node);
  ...
  _vres = camlidl_cudd_c2ml_add_add__t(&_res, _ctx);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_cudd_add_delse(
	value _v_no)
{
  add__t no; /*in*/
  add__t _res;
...
value camlidl_cudd_add_cofactor(
	value _v_no1,
	value _v_no2)
{
  add__t no1; /*in*/
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_add_add__t(_v_no1, &no1, _ctx);
  camlidl_cudd_ml2c_bdd_bdd__dt(_v_no2, &no2, _ctx);
  /* begin user-supplied calling sequence */
	...
	value _v_no3)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_bdd_bdd__dt(_v_no1, &no1, _ctx);
  camlidl_cudd_ml2c_add_add__t(_v_no2, &no2, _ctx);
  camlidl_cudd_ml2c_add_add__t(_v_no3, &no3, _ctx);
  /* begin user-supplied calling sequence */
...
value camlidl_cudd_add_ite_cst(
	value _v_no1,
	value _v_no2,
	value _v_no3)
{
  ...
  if (_res == NULL) {
    ...
    _v1 = camlidl_cudd_c2ml_add_add__t(&*_res, _ctx);
    Begin_root(_v1)
...
value camlidl_cudd_add_eval_cst(
	value _v_no1,
	value _v_no2)
{
  add__t no1; /*in*/
...
value camlidl_cudd_add_compose(
	value _v_var,
	value _v_no1,
	value _v_no2)
{
...
value camlidl_cudd_add_nbleaves(
	value _v_no)
{
  add__t no; /*in*/
  int _res;
...
value camlidl_cudd_add_guard_of_node(
	value _v_no1,
	value _v_no2)
{
  add__t no1; /*in*/
...
End_roots();
  ...
  /* end user-supplied calling sequence */
  _vres = camlidl_cudd_c2ml_bdd_bdd__dt(&_res, _ctx);
  camlidl_free(_ctx);
  return _vres;
}

value camlidl_cudd_add_guard_of_nonbackground(
	value _v_no)
{
  add__t no; /*in*/
  bdd__dt _res;
...
value camlidl_cudd_add_constrain(
	value _v_no1,
	value _v_no2)
{
  add__t no1; /*in*/
...
value camlidl_cudd_add_tdconstrain(
	value _v_no1,
	value _v_no2)
{
  add__t no1; /*in*/
...
value camlidl_cudd_add_restrict(
	value _v_no1,
	value _v_no2)
{
  add__t no1; /*in*/
...
value camlidl_cudd_add_tdrestrict(
	value _v_no1,
	value _v_no2)
{
  add__t no1; /*in*/
	...
	value _v_no)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_bdd_bdd__dt(_v_no, &no, _ctx);
  /* begin user-supplied calling sequence */
...
value camlidl_cudd_add_to_bdd_threshold(
	value _v_val,
	value _v_no)
{
  double val; /*in*/
...
value camlidl_cudd_add_to_bdd_strictthreshold(
	value _v_val,
	value _v_no)
{
  double val; /*in*/
...
value camlidl_cudd_add_to_bdd_interval(
	value _v_lower,
	value _v_upper,
	value _v_no)
{
...
value camlidl_cudd_add_agreement(
	value _v_no1,
	value _v_no2)
{
  add__t no1; /*in*/
...
value camlidl_cudd_add_threshold(
	value _v_no1,
	value _v_no2)
{
  add__t no1; /*in*/
...
value camlidl_cudd_add_matrix_multiply(value _v_array, value _v_no1, value _v_no2)
{
...
value camlidl_cudd_add_times_plus(value _v_array, value _v_no1, value _v_no2)
{
  CAMLparam3(_v_array,_v_no1,_v_no2); CAMLlocal1(_v_res);
  int i,size;
  DdNode** array;
...
value camlidl_cudd_add_triangle(value _v_array, value _v_no1, value _v_no2)
{
  CAMLparam3(_v_array,_v_no1,_v_no2); CAMLlocal1(_v_res);
  int i,size;
  DdNode** array;
...
value camlidl_cudd_add_transfer(
	value _v_no,
	value _v_man)
{
  add__t no; /*in*/
