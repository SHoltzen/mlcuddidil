...
extern int camlidl_cudd_ml2c_memo_enum_memo_discr(value);
extern value camlidl_cudd_c2ml_memo_enum_memo_discr(int);

extern int camlidl_cudd_transl_table_memo_enum_memo_discr[];

extern int camlidl_cudd_ml2c_memo_union_memo_union(value, union memo_union *, camlidl_ctx _ctx);
extern value camlidl_cudd_c2ml_memo_union_memo_union(int, union memo_union *, camlidl_ctx _ctx);

extern void camlidl_cudd_ml2c_memo_struct_memo__t(value, struct memo__t *, camlidl_ctx _ctx);
extern value camlidl_cudd_c2ml_memo_struct_memo__t(struct memo__t *, camlidl_ctx _ctx);
...
#define camlidl_cudd_ml2c_vdd_vdd__t(v,c,ctx) camlidl_cudd_node_ml2c(v,c)

extern value camlidl_cudd_node_c2ml(vdd__t *);
#define camlidl_cudd_c2ml_vdd_vdd__t(c,ctx) camlidl_cudd_node_c2ml(c)


#define camlidl_cudd_ml2c_custom_pid(v,c,ctx) camlidl_cudd_pid_ml2c(v,c)

#define camlidl_cudd_c2ml_custom_pid(c,ctx) camlidl_cudd_pid_c2ml(c)

#define camlidl_cudd_ml2c_custom_mlvalue(v,c,ctx) camlidl_cudd_mlvalue_ml2c(v,c)

#define camlidl_cudd_c2ml_custom_mlvalue(c,ctx) camlidl_cudd_mlvalue_c2ml(c)

void camlidl_cudd_ml2c_custom_struct_common(value _v1, struct common * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  value _v5;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_pid(_v3, &(*_c2).pid, _ctx);
  _v4 = Field(_v1, 1);
  (*_c2).arity = Int_val(_v4);
  _v5 = Field(_v1, 2);
  camlidl_cudd_ml2c_memo_struct_memo__t(_v5, &(*_c2).memo, _ctx);
  (*_c2).man = NULL;
  (*_c2).exn = NULL;
}

value camlidl_cudd_c2ml_custom_struct_common(struct common * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[3];
  _v3[0] = _v3[1] = _v3[2] = 0;
  Begin_roots_block(_v3, 3)
    _v3[0] = camlidl_cudd_c2ml_custom_pid(&(*_c1).pid, _ctx);
    _v3[1] = Val_int((*_c1).arity);
    _v3[2] = camlidl_cudd_c2ml_memo_struct_memo__t(&(*_c1).memo, _ctx);
...
void camlidl_cudd_ml2c_custom_struct_op1(value _v1, struct op1 * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_struct_common(_v3, &(*_c2).common1, _ctx);
  _v4 = Field(_v1, 1);
  camlidl_cudd_ml2c_custom_mlvalue(_v4, &(*_c2).closure1, _ctx);
  (*_c2).funptr1 = NULL;
}

value camlidl_cudd_c2ml_custom_struct_op1(struct op1 * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[2];
  _v3[0] = _v3[1] = 0;
  Begin_roots_block(_v3, 2)
    _v3[0] = camlidl_cudd_c2ml_custom_struct_common(&(*_c1).common1, _ctx);
    _v3[1] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).closure1, _ctx);
...
void camlidl_cudd_ml2c_custom_struct_op2(value _v1, struct op2 * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  value _v5;
  ...
  value _v7;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_struct_common(_v3, &(*_c2).common2, _ctx);
  _v4 = Field(_v1, 1);
  camlidl_cudd_ml2c_custom_mlvalue(_v4, &(*_c2).closure2, _ctx);
  _v5 = Field(_v1, 2);
  camlidl_cudd_ml2c_custom_mlvalue(_v5, &(*_c2).ospecial2, _ctx);
  _v6 = Field(_v1, 3);
...
value camlidl_cudd_c2ml_custom_struct_op2(struct op2 * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[5];
  memset(_v3, 0, 5 * sizeof(value));
  Begin_roots_block(_v3, 5)
    _v3[0] = camlidl_cudd_c2ml_custom_struct_common(&(*_c1).common2, _ctx);
    _v3[1] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).closure2, _ctx);
    _v3[2] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).ospecial2, _ctx);
...
void camlidl_cudd_ml2c_custom_struct_test2(value _v1, struct test2 * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  value _v5;
  ...
  value _v7;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_struct_common(_v3, &(*_c2).common2t, _ctx);
  _v4 = Field(_v1, 1);
  camlidl_cudd_ml2c_custom_mlvalue(_v4, &(*_c2).closure2t, _ctx);
  _v5 = Field(_v1, 2);
  camlidl_cudd_ml2c_custom_mlvalue(_v5, &(*_c2).ospecial2t, _ctx);
  _v6 = Field(_v1, 3);
...
value camlidl_cudd_c2ml_custom_struct_test2(struct test2 * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[5];
  memset(_v3, 0, 5 * sizeof(value));
  Begin_roots_block(_v3, 5)
    _v3[0] = camlidl_cudd_c2ml_custom_struct_common(&(*_c1).common2t, _ctx);
    _v3[1] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).closure2t, _ctx);
    _v3[2] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).ospecial2t, _ctx);
...
void camlidl_cudd_ml2c_custom_struct_op3(value _v1, struct op3 * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  value _v5;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_struct_common(_v3, &(*_c2).common3, _ctx);
  _v4 = Field(_v1, 1);
  camlidl_cudd_ml2c_custom_mlvalue(_v4, &(*_c2).closure3, _ctx);
  _v5 = Field(_v1, 2);
  camlidl_cudd_ml2c_custom_mlvalue(_v5, &(*_c2).ospecial3, _ctx);
  (*_c2).funptr3 = NULL;
}

value camlidl_cudd_c2ml_custom_struct_op3(struct op3 * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[3];
  _v3[0] = _v3[1] = _v3[2] = 0;
  Begin_roots_block(_v3, 3)
    _v3[0] = camlidl_cudd_c2ml_custom_struct_common(&(*_c1).common3, _ctx);
    _v3[1] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).closure3, _ctx);
    _v3[2] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).ospecial3, _ctx);
    _v2 = camlidl_alloc_small(3, 0);
    Field(_v2, 0) = _v3[0];
    Field(_v2, 1) = _v3[1];
    Field(_v2, 2) = _v3[2];
...
void camlidl_cudd_ml2c_custom_struct_opN(value _v1, struct opN * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  value _v5;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_struct_common(_v3, &(*_c2).commonN, _ctx);
  _v4 = Field(_v1, 1);
  (*_c2).arityNbdd = Int_val(_v4);
  _v5 = Field(_v1, 2);
  camlidl_cudd_ml2c_custom_mlvalue(_v5, &(*_c2).closureN, _ctx);
  (*_c2).funptrN = NULL;
}

value camlidl_cudd_c2ml_custom_struct_opN(struct opN * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[3];
  _v3[0] = _v3[1] = _v3[2] = 0;
  Begin_roots_block(_v3, 3)
    _v3[0] = camlidl_cudd_c2ml_custom_struct_common(&(*_c1).commonN, _ctx);
    _v3[1] = Val_int((*_c1).arityNbdd);
    _v3[2] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).closureN, _ctx);
    _v2 = camlidl_alloc_small(3, 0);
    Field(_v2, 0) = _v3[0];
    Field(_v2, 1) = _v3[1];
    Field(_v2, 2) = _v3[2];
...
void camlidl_cudd_ml2c_custom_struct_opG(value _v1, struct opG * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  value _v5;
  ...
  value _v7;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_struct_common(_v3, &(*_c2).commonG, _ctx);
  _v4 = Field(_v1, 1);
  (*_c2).arityGbdd = Int_val(_v4);
  _v5 = Field(_v1, 2);
  camlidl_cudd_ml2c_custom_mlvalue(_v5, &(*_c2).closureG, _ctx);
  (*_c2).funptrG = NULL;
  _v6 = Field(_v1, 3);
  camlidl_cudd_ml2c_custom_mlvalue(_v6, &(*_c2).oclosureBeforeRec, _ctx);
  (*_c2).funptrBeforeRec = NULL;
  _v7 = Field(_v1, 4);
  camlidl_cudd_ml2c_custom_mlvalue(_v7, &(*_c2).oclosureIte, _ctx);
  (*_c2).funptrIte = NULL;
}

value camlidl_cudd_c2ml_custom_struct_opG(struct opG * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[5];
  memset(_v3, 0, 5 * sizeof(value));
  Begin_roots_block(_v3, 5)
    _v3[0] = camlidl_cudd_c2ml_custom_struct_common(&(*_c1).commonG, _ctx);
    _v3[1] = Val_int((*_c1).arityGbdd);
    _v3[2] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).closureG, _ctx);
    _v3[3] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).oclosureBeforeRec, _ctx);
    _v3[4] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).oclosureIte, _ctx);
    _v2 = camlidl_alloc_small(5, 0);
    { mlsize_t _c4;
      for (_c4 = 0; _c4 < 5; _c4++) Field(_v2, _c4) = _v3[_c4];
    }
...
void camlidl_cudd_ml2c_custom_struct_exist(value _v1, struct exist * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_struct_common(_v3, &(*_c2).commonexist, _ctx);
  _v4 = Field(_v1, 1);
  camlidl_cudd_ml2c_custom_struct_op2(_v4, &(*_c2).combineexist, _ctx);
}

value camlidl_cudd_c2ml_custom_struct_exist(struct exist * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[2];
  _v3[0] = _v3[1] = 0;
  Begin_roots_block(_v3, 2)
    _v3[0] = camlidl_cudd_c2ml_custom_struct_common(&(*_c1).commonexist, _ctx);
    _v3[1] = camlidl_cudd_c2ml_custom_struct_op2(&(*_c1).combineexist, _ctx);
    _v2 = camlidl_alloc_small(2, 0);
    Field(_v2, 0) = _v3[0];
    Field(_v2, 1) = _v3[1];
  End_roots()
...
void camlidl_cudd_ml2c_custom_struct_existand(value _v1, struct existand * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  value _v5;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_struct_common(_v3, &(*_c2).commonexistand, _ctx);
  _v4 = Field(_v1, 1);
  camlidl_cudd_ml2c_custom_struct_op2(_v4, &(*_c2).combineexistand, _ctx);
  _v5 = Field(_v1, 2);
  camlidl_cudd_ml2c_custom_mlvalue(_v5, &(*_c2).bottomexistand, _ctx);
}

value camlidl_cudd_c2ml_custom_struct_existand(struct existand * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[3];
  _v3[0] = _v3[1] = _v3[2] = 0;
  Begin_roots_block(_v3, 3)
    _v3[0] = camlidl_cudd_c2ml_custom_struct_common(&(*_c1).commonexistand, _ctx);
    _v3[1] = camlidl_cudd_c2ml_custom_struct_op2(&(*_c1).combineexistand, _ctx);
    _v3[2] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).bottomexistand, _ctx);
    _v2 = camlidl_alloc_small(3, 0);
    Field(_v2, 0) = _v3[0];
    Field(_v2, 1) = _v3[1];
    Field(_v2, 2) = _v3[2];
...
void camlidl_cudd_ml2c_custom_struct_existop1(value _v1, struct existop1 * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  value _v5;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_struct_common(_v3, &(*_c2).commonexistop1, _ctx);
  _v4 = Field(_v1, 1);
  camlidl_cudd_ml2c_custom_struct_op2(_v4, &(*_c2).combineexistop1, _ctx);
  _v5 = Field(_v1, 2);
  camlidl_cudd_ml2c_custom_struct_op1(_v5, &(*_c2).existop1, _ctx);
}

value camlidl_cudd_c2ml_custom_struct_existop1(struct existop1 * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[3];
  _v3[0] = _v3[1] = _v3[2] = 0;
  Begin_roots_block(_v3, 3)
    _v3[0] = camlidl_cudd_c2ml_custom_struct_common(&(*_c1).commonexistop1, _ctx);
    _v3[1] = camlidl_cudd_c2ml_custom_struct_op2(&(*_c1).combineexistop1, _ctx);
    _v3[2] = camlidl_cudd_c2ml_custom_struct_op1(&(*_c1).existop1, _ctx);
    _v2 = camlidl_alloc_small(3, 0);
    Field(_v2, 0) = _v3[0];
    Field(_v2, 1) = _v3[1];
    Field(_v2, 2) = _v3[2];
...
void camlidl_cudd_ml2c_custom_struct_existandop1(value _v1, struct existandop1 * _c2, camlidl_ctx _ctx)
{
  value _v3;
  value _v4;
  value _v5;
  value _v6;
  _v3 = Field(_v1, 0);
  camlidl_cudd_ml2c_custom_struct_common(_v3, &(*_c2).commonexistandop1, _ctx);
  _v4 = Field(_v1, 1);
  camlidl_cudd_ml2c_custom_struct_op2(_v4, &(*_c2).combineexistandop1, _ctx);
  _v5 = Field(_v1, 2);
  camlidl_cudd_ml2c_custom_struct_op1(_v5, &(*_c2).existandop1, _ctx);
  _v6 = Field(_v1, 3);
  camlidl_cudd_ml2c_custom_mlvalue(_v6, &(*_c2).bottomexistandop1, _ctx);
}

value camlidl_cudd_c2ml_custom_struct_existandop1(struct existandop1 * _c1, camlidl_ctx _ctx)
{
  value _v2;
  value _v3[4];
  _v3[0] = _v3[1] = _v3[2] = _v3[3] = 0;
  Begin_roots_block(_v3, 4)
    _v3[0] = camlidl_cudd_c2ml_custom_struct_common(&(*_c1).commonexistandop1, _ctx);
    _v3[1] = camlidl_cudd_c2ml_custom_struct_op2(&(*_c1).combineexistandop1, _ctx);
    _v3[2] = camlidl_cudd_c2ml_custom_struct_op1(&(*_c1).existandop1, _ctx);
    _v3[3] = camlidl_cudd_c2ml_custom_mlvalue(&(*_c1).bottomexistandop1, _ctx);
...
_res = malloc(1);
  ...
  _vres = camlidl_cudd_c2ml_custom_pid(&_res, _ctx);
  camlidl_free(_ctx);
  return _vres;
}
	...
	value _v_no)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_custom_struct_op1(_v_op, &op, _ctx);
  camlidl_cudd_ml2c_vdd_vdd__t(_v_no, &no, _ctx);
  /* begin user-supplied calling sequence */
	...
	value _v_no2)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_custom_struct_op2(_v_op, &op, _ctx);
  camlidl_cudd_ml2c_vdd_vdd__t(_v_no1, &no1, _ctx);
  camlidl_cudd_ml2c_vdd_vdd__t(_v_no2, &no2, _ctx);
  /* begin user-supplied calling sequence */
	...
	value _v_no2)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_custom_struct_test2(_v_op, &op, _ctx);
  camlidl_cudd_ml2c_vdd_vdd__t(_v_no1, &no1, _ctx);
  camlidl_cudd_ml2c_vdd_vdd__t(_v_no2, &no2, _ctx);
  /* begin user-supplied calling sequence */
	...
	value _v_no3)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_custom_struct_op3(_v_op, &op, _ctx);
  camlidl_cudd_ml2c_vdd_vdd__t(_v_no1, &no1, _ctx);
  camlidl_cudd_ml2c_vdd_vdd__t(_v_no2, &no2, _ctx);
  camlidl_cudd_ml2c_vdd_vdd__t(_v_no3, &no3, _ctx);
  /* begin user-supplied calling sequence */
	...
	value _v_no2)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_custom_struct_exist(_v_op, &op, _ctx);
	...
	value _v_no3)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_custom_struct_existand(_v_op, &op, _ctx);
  camlidl_cudd_ml2c_bdd_bdd__t(_v_no1, &no1, _ctx);
	...
	value _v_no2)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_custom_struct_existop1(_v_op, &op, _ctx);
  camlidl_cudd_ml2c_bdd_bdd__t(_v_no1, &no1, _ctx);
  camlidl_cudd_ml2c_vdd_vdd__t(_v_no2, &no2, _ctx);
  /* begin user-supplied calling sequence */
	...
	value _v_no3)
{
  ...
  struct camlidl_ctx_struct _ctxs = { CAMLIDL_TRANSIENT, NULL };
  camlidl_ctx _ctx = &_ctxs;
  camlidl_cudd_ml2c_custom_struct_existandop1(_v_op, &op, _ctx);
  camlidl_cudd_ml2c_bdd_bdd__t(_v_no1, &no1, _ctx);
  camlidl_cudd_ml2c_bdd_bdd__t(_v_no2, &no2, _ctx);
  camlidl_cudd_ml2c_vdd_vdd__t(_v_no3, &no3, _ctx);
  /* begin user-supplied calling sequence */
